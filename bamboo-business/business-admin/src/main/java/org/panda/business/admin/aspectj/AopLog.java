package org.panda.business.admin.aspectj;
...
public class AopLog {
     ...
     */
    @Pointcut("execution(public * org.panda.business.admin.modules..*Controller.*(..))")
    public void log() {
    ...
    public Object aroundLog(ProceedingJoinPoint point) throws Throwable {
      ...
      log.info("Request Log Info : 【{}】 {}", requestURI, JSONUtil.toJsonStr(l_request));
      ...
      log.info("Response Log Info : 【{}】 {}", requestURI, JSONUtil.toJsonStr(l_result));
